...
class Music extends StatefulWidget {
  final User user;
  const Music({Key? key, required this.user}) : super(key: key);
...
class _MusicState extends State<Music> {
            ...
            musicData == []
                ...
                : SizedBox(
                    ...
                    child: GridView.count(
                        ...
                        children: List.generate(musicData.length, (index) {
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        width: screenWidth / 3,
                                        imageUrl:
                                            "https://seriouslaa.com/rentApplicationSystem/website/images/equipment/${musicData[index]['EQUIPMENTNAME'] + ".jpg"}",
                ...
                child: Column(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(musicData[index]['EQUIPMENTNAME'],
                            style: TextStyle(
                                fontSize: 16, fontWeight: FontWeight.bold)),
                        Text(musicData[index]['EQUIPMENTTYPE'],
                            style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey,
                    ...
                    Row(
                      children: [
                        ...
                        Text(" RM " + musicData[index]['DEPOSIT'],
                            style: TextStyle(
                                fontSize: 14,
                                color: Colors.black,
                                fontWeight: FontWeight.bold)),
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            Text("RM " + musicData[index]['PRICEUUM'],
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold)),
                            Text(" ",
                                style: TextStyle(
                                    ...
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold)),
                            Text("RM " + musicData[index]['PRICESTAFF'],
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold)),
  ...
  void _addtoCart(int index) {
    try {
      int cquantity = int.parse(musicData[index]["QUANTITY"]);
      ...
      if (cquantity > 0 && selectedQuantity < cquantity) {
        ...
        http.post(Uri.parse(server + "/insert_cart.php"), body: {
          ...
          "equipmentid": musicData[index]["EQUIPMENTID"],
    ...
    await http.post(Uri.parse(server + "/load_equipment.php"), body: {
      ...
      if (res.body == "nodata") {
        ...
        setState(() {
          ...
          musicData = extractdata["equipments"];
